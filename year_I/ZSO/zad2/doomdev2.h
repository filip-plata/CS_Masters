...
#define DOOMDEV2_IOCTL_CREATE_TEXTURE _IOW('D', 0x01, struct doomdev2_ioctl_create_buffer)
...
_Static_assert(sizeof (struct doomdev2_cmd_copy_rect) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd_fill_rect) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd_draw_line) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd_draw_background) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd_draw_column) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd_draw_span) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd_draw_fuzz) == 32, "");
_Static_assert(sizeof (struct doomdev2_cmd) == 32, "");
